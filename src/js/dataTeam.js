...
export const modalDataTeam = [
  {
    url: maximEremeevUrl,
    laptop: maximEremeevDtUrl,
    Phone: maximEremeevPhUrl,
    href: 'https://github.com/Maksmaximusmaxim',
    nameEmp: 'Maxim Eremeev',
    position: 'Team Lead',
  },
  {
    url: olyaZarichnaUrl,
    laptop: olyaZarichnaDtUrl,
    Phone: olyaZarichnaPhUrl,
    href: 'https://github.com/Olyazarichna',
    nameEmp: 'Olya Zarichna',
    position: 'Scrum Master',
  },
  {
    url: vitaliiPiddubchakUrl,
    laptop: vitaliiPiddubchakDtUrl,
    Phone: vitaliiPiddubchakPhUrl,
    href: 'https://github.com/Vitaliy28031985',
    nameEmp: 'Vitalii Piddubchak',
    position: 'Developer',
  },
  {
    url: andriiBerezhkoUrl,
    laptop: andriiBerezhkoDtUrl,
    Phone: andriiBerezhkoPhUrl,
    href: 'https://github.com/andriiberezhko',
    nameEmp: 'Andrii Berezhko',
    position: 'Developer',
  },
  {
    url: andriiReznichenkoUrl,
    laptop: andriiReznichenkoDtUrl,
    Phone: andriiReznichenkoPhUrl,
    href: 'https://github.com/4ezeronnik',
    nameEmp: 'Andrii Reznichenko',
    position: 'Developer',
  },
  {
    url: oxanaDemovaUrl,
    laptop: oxanaDemovaDtUrl,
    Phone: oxanaDemovaPhUrl,
    href: 'https://github.com/OxanaDemova',
    nameEmp: 'Oxana Demova',
    position: 'Developer',
  },
  {
    url: volodymyrGanzelevskyiUrl,
    laptop: volodymyrGanzelevskyiDtUrl,
    Phone: volodymyrGanzelevskyiPhUrl,
    href: 'https://github.com/zganz',
    nameEmp: 'Volodymyr Ganzelevskyi',
    position: 'Developer',
  },
  {
    url: maksymAfanasievUrl,
    laptop: maksymAfanasievDtUrl,
    Phone: maksymAfanasievPhUrl,
    href: 'https://github.com/MaksimAfanasiev',
    nameEmp: 'Maksym Afanasiev',
    position: 'Developer',
  },
  {
    url: dimaSyrdiiUrl,
